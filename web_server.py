...
setInterval(updateTimers, 1000);
setInterval(() = > location.reload(), 5000); // Refresh
every
5
seconds
for new data
...
class ="prediction-id" > ID: {{pred_id}} <
...
class ="closed-badge" > BETTING CLOSED < / span >
...
class ="question" > {{prediction.question}} < / div >
...
class ="answer believe-answer" >

< div


class ="answer-label" > ✅ Believe < / div >

< div


class ="answer-text" > {{prediction.believe_answer}} < / div >

< / div >
< div


class ="answer doubt-answer" >

< div


class ="answer-label" > ❌ Doubt < / div >

< div


class ="answer-text" > {{prediction.doubt_answer}} < / div >
...
class ="believe-bar" style="width: {{ prediction.believe_percentage }}%;" >

< span


class ="bar-label" > {{prediction.believe_percentage}} % < / span >

< / div >
< div


class ="doubt-bar" style="width: {{ prediction.doubt_percentage }}%;" >

< span


class ="bar-label" > {{prediction.doubt_percentage}} % < / span >
...
class ="stat-label" > Believe Bets < / div >

< div


class ="stat-value" style="color: #5BA3F5;" > {{prediction.believe_points}} < / div >
...
class ="stat-label" > Total Bettors < / div >

< div


class ="stat-value" > {{prediction.total_bettors}} < / div >
...
class ="stat-label" > Doubt Bets < / div >

< div


class ="stat-value" style="color: #F55BA3;" > {{prediction.doubt_points}} < / div >
...
class ="point-name" > Currency: {{prediction.point_name}} <
...
class ="timer" data-end-time="{{ prediction.ending_timestamp }}" >
...
def api_all_predictions(guild_id, token):
    ...
    data = get_prediction_data(guild_id, user_id)
    if data is None:
        abort(404, description="Guild not found or no predictions")
